...
test("only guarded accepted completion has a zero delivery exit code and summary retains recovery context", () => {
  ...
  assert.equal(deliveryExitCode({ state: "completed_merged", completionContractVersion: 2, publish: { acceptanceReportId: "acceptance-1" } }), 0);
