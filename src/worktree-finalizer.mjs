...
export class WorktreeFinalizer {
  ...
  async finalize({ task, worktree, branch, overlay, overlayPath }) {
    ...
    const artifact = {
      ...
      overlay: { schemaVersion: overlay.schemaVersion, path: overlayPath }, parentArtifactId: parentIds[0] ?? null,
      // Kept as historical/read compatibility metadata.  New consumers use
      // parentArtifactId and reject multi-parent legacy values.
